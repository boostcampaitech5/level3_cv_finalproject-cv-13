...
from inference.misc.pano_lsd_align import panoEdgeDetection, rotatePanorama
from inference.lib.config import config, update_config
...
def run_main(seed):
    ...
    # parser.add_argument('--cfg', default = "./inference/config/s2d3d_depth/HOHO_depth_dct_efficienthc_TransEn1.yaml")
    # parser.add_argument('--pth', default = "./inference/checkpoints/depth/depth.pth")
